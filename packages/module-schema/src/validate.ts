...
import { moduleSchema, type FatelineModule } from './module.js';
 ...
 */
export function validateModule(input: unknown): ValidationResult<FatelineModule> {
  const parsed = safeParse(moduleSchema, input);
